...
-[ProfileStore]
	...
	Functions:
		...
		ProfileStore.New(store_name, template?) 
			store_name   [string] 
			template     [table] or nil 
	...
	Methods [ProfileStore]:
		...
		ProfileStore:StartSessionAsync(profile_key, params?) 
			profile_key [string] 
			params      nil or [table]: 
				{
					Steal = true, 
		...
		ProfileStore:GetAsync(profile_key, version?) 
			
			profile_key   [string] 
			version       nil or [string] 

		ProfileStore:VersionQuery(profile_key, sort_direction?, min_date?, max_date?) 
			profile_key      [string]
			sort_direction   nil or [Enum.SortDirection]
			min_date         nil or [DateTime]
			max_date         nil or [DateTime]
			
		ProfileStore:RemoveAsync(profile_key) 
